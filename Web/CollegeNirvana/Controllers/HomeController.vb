...
Imports risersoft.shared.portable.Models.AuthPublic
...
Public Class HomeController
    ...
    Function BuyApp() As ActionResult
        ...
        Return Me.Redirect(portal & "/account/create?license=buy&product=CollegeNirvana")
    End Function
    Function TryApp() As ActionResult
        Dim portal As String = Me.Host.Portal.ToRootString
        Return Me.Redirect(portal & "/account/create?license=try&product=CollegeNirvana")
    End Function
End Class