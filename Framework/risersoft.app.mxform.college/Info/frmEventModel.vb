...
Public Class frmEventModel
    ...
    Private Sub InitForm()
        ...
        Sql = myFuncs.CodeWordSQL("EventDetail", "EventType", "")
    ...
    Public Overrides Function PrepForm(oView As clsViewModel, ByVal prepMode As EnumfrmMode, ByVal prepIDX As String, Optional ByVal strXML As String = "") As Boolean
        ...
        Sql = "Select deptid, deptname from department where CompanyID = " & myUtils.cValTN(myRow("CompanyID")) & " order by deptname"
    ...
    Public Overrides Function GenerateParamsOutput(dataKey As String, Params As List(Of clsSQLParam)) As clsProcOutput
        ...
        oRet = myCollegeFuncs.GenerateCommonOutput(myContext, dataKey, Params, "eventId")
        Return oRet
    End Function
                ...
                Select Case EntityKey.Trim.ToLower
                    Case "event"
                        ...
                        If dt.Rows.Count > 0 Then
                            Dim sql1 As String = "delete from EventDetail where EventID =" & ID
