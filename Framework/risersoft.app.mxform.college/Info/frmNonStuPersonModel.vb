...
Public Class frmNonStuPersonModel
    ...
    Private Sub InitForm()
        ...
        Me.AddLookupField("DeptRank", "Rank")

        Me.ValueLists.Add("NonTechStaffRank", vlist5)
        Me.AddLookupField("NonTechStaffRank", "NonTechStaffRank")
    ...
    Public Overrides Function PrepForm(oView As clsViewModel, ByVal prepMode As EnumfrmMode, ByVal prepIDX As String, Optional ByVal strXML As String = "") As Boolean
        ...
        str2 = "<BAND INDEX=""0"" TABLE=""persedu"" IDFIELD=""perseduid"" ><COL KEY=""Qualification,Institution,Board,YearQual,Marks,PerMarks,personid""/></BAND> "
        ...
        Sql = "Select Companyid, CompName from Company " & str1 & " Order by CompName"
    ...
    Public Overrides Function VSave() As Boolean
        ...
        If Me.Validate Then
            ...
            If myUtils.cStrTN(myRow("StaffMode")).Trim.Length > 0 AndAlso myUtils.cStrTN(myRow("StaffDept")).Trim.Length > 0 Then
                myRow("NonTeacStaff") = True
            Else
                myRow("NonTeacStaff") = False
            End If
