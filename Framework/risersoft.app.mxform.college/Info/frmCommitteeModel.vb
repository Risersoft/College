...
Public Class frmCommitteeModel
    ...
    Public Overrides Function PrepForm(oView As clsViewModel, ByVal prepMode As EnumfrmMode, ByVal prepIDX As String, Optional ByVal strXML As String = "") As Boolean
        ...
        Sql = "Select CommitteeMemberID,CommitteeID,Occupation,PersonID,Rank,FullName,CommDesig,Sdate,Edate from ClgListCommitteeMemberView where CommitteeID = " & frmIDX & " Order By Rank"
        myView.MainGrid.MainConf("FORMATXML") = "<COL KEY=""FullName"" CAPTION=""Member Name""/><COL KEY=""Sdate"" CAPTION=""Start Date""/><COL KEY=""Edate"" CAPTION=""End Date""/>"
        myView.MainGrid.QuickConf(Sql, True, "1-1-1-1", True)
        str1 = "<BAND INDEX=""0"" TABLE=""CommitteeMember"" IDFIELD=""CommitteeMemberID""><COL NOEDIT=""True"" KEY=""PersonID "" LOOKUPSQL = ""Select PersonID, FullName from Persons " & str2 & " "" CAPTION = ""Member Name""/>
    ...
    Public Overrides Function Validate() As Boolean
        ...
        If myUtils.cStrTN(myRow("CommitteeCode")).Trim.Length = 0 Then Me.AddError("CommitteeCode", "Please Select Committee Code")
    ...
    Public Overrides Function GenerateParamsModel(vwState As clsViewState, SelectionKey As String, Params As List(Of clsSQLParam)) As clsViewModel
        ...
        Dim str2 As String = myUtils.CombineWhere(False, myContext.AppModel.strFilterDBAppUser(myContext, Me.fRow, "CompanyID"))
        str2 = myUtils.CombineWhereOR(False, str2, "companyid is null")

        If oRet.Success Then
            Select Case SelectionKey.Trim.ToLower
                Case "committeemember"
                    Model = myContext.Provider.GenerateSelectionModel(vwState, "<SYS ID=""PersonID""/>", True, , "<MODROW><SQLWHERE2>" & str2 & "</SQLWHERE2></MODROW>")
