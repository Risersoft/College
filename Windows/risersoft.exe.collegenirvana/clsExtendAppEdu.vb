...
Public Class clsExtendAppEdu
    ...
    Public Overrides Function GetLicProductInfo() As LicProductInfo
        Return New LicProductInfo("nclgmgr", 1.0, "CollegeNirvana.Std")
    End Function
    ...
    Public Overrides Function dicFormModelTypes() As clsCollecString(Of Type)
        If dicFormModel Is Nothing Then
            ...
            Me.AddTypeAssembly(dicFormModel, GetType(frmStudentModel).Assembly, GetType(clsFormDataModel))
            Me.AddTypeAssembly(dicFormModel, GetType(frmAlumniModel).Assembly, GetType(clsFormDataModel))
